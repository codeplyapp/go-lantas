import { TrafficHotspot, TrafficIncident, TrafficSegment } from '../core/types';
 ...
 * Total: 121 Titik Geometri Jalan Terverifikasi OpenStreetMap / Carto
 */
export const BANYUWANGI_NAVIGATION_ROUTE: [number, number][] = [
  [
    -8.221694,
    114.364565
  ],
...
export const BANYUWANGI_TRAFFIC_SEGMENTS: TrafficSegment[] = [
  ...
  {
    id: 'seg_pandan_taruna',
    nama_jalan: 'Jl. Pandan & Raya Genteng (Rute SMAN 2 Taruna Bhayangkara)',
    polyline: [
  [
    -8.216162,
    114.367982
...
export const BANYUWANGI_INCIDENTS: TrafficIncident[] = [
  ...
  {
    id: 'inc_bwi_03',
    judul: 'Zona Selamat Sekolah (ZOSS) Taruna Presisi',
    lokasi: 'Kawasan SMAN 2 Taruna Bhayangkara, Genteng',
    koordinat: [-8.3582, 114.1548],
    tipe: 'contraflow',
    status: 'aktif',
    waktu: '06:30 - 07:30',
    deskripsi: 'ZOSS Presisi Terpadu aktif dengan pendampingan Polantas & PKS Kebhayangkaraan di zebra cross sekolah.',
    label_simulasi: true,
  },
];
...
export const BANYUWANGI_SAFE_ROUTES = [
  {
    id: 'safe_01',
    nama: 'Rute Pelajar Hijau (Pusat Kota ke SMAN 2 Taruna Bhayangkara)',
    titik_mulai: 'Jl. Ahmad Yani (Taman Blambangan / RTH Genteng)',
    titik_akhir: 'SMAN 2 Taruna Bhayangkara Jawa Timur (Jl. Pandan)',
    jarak: '4.2 km',
    estimasi_waktu: '8 menit',
    rekomendasi: 'Melintasi lajur tertib lalu lintas terpadu ZOSS Kebhayangkaraan. Dilengkapi kamera pantau Korlantas Presisi.',
  }
];
